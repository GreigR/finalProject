...
For Game theory to remain relevant some practitioners would need to move away from the current Nash equibrium arcs to demonstrate the importance of the relationship between location and economic drivers.  
